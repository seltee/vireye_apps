clang++ --target=thumb -mthumb -mfloat-abi=soft -c -m32 -Os -fdeclspec runner.cpp selector.cpp utils.cpp sound_player.cpp
..\linker runner.o selector.o utils.o sound_player.o autorun.vex
